                          ...
                          {tableData.map((tableItem, key) => (
                            <tr key={key}>
                              ...
                              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className="text-black dark:text-white text-sm">{tableItem.ipAddress}</p>
                              </td>
                              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className="text-black dark:text-white text-sm">{tableItem.country}</p>
                              </td>
                              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium ${
                                  tableItem.status === 'Paid' ? 'bg-success text-success'
                                    : tableItem.status === 'Inactive' ? 'bg-danger text-danger'
                              ...
                              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className="text-black dark:text-white text-sm">{tableItem.lastActiveTime}</p>
                              </td>
                              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                <p className="text-black dark:text-white text-sm">{tableItem.additionalSystemDetails}</p>
                              </td>
                              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
