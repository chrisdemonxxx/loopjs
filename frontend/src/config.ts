...
const BACKEND_URL = isLocal ? 'http://localhost:8080' : 'https://loopjs-backend-kn2yg4ji5a-uc.a.run.app';
...
export const WS_URL = isLocal ? 'ws://localhost:8080/ws' : 'wss://loopjs-backend-kn2yg4ji5a-uc.a.run.app/ws';
