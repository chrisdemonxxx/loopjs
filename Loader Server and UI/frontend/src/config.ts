...
const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || (isLocal ? 'http://localhost:8080' : '');
...
export const WS_URL = import.meta.env.VITE_WS_URL || (isLocal ? 'ws://localhost:8080/ws' : `${BACKEND_URL.replace('https://', 'wss://')}/ws`);
