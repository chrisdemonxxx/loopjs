...
const corsOptions = {
    origin: function (origin, callback) {
        ...
        const allowedOrigins = [
            ...
            'https://www.sendparcel.art', // Your custom domain
            'https://loopjs-by-loopcreations-6p0gj7w5b-chrisdemonxxxs-projects.vercel.app' // The specific Vercel URL
        ];

        // Check if the incoming origin is in your list
